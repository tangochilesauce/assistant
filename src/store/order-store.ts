  ...
  return [
    {
      ...
      checklist: [
        { id: 'ck-unfi-1', text: 'Bottle from botes: 504 Mild', done: false },
        { id: 'ck-unfi-2', text: 'Bottle from botes: 216 Hot', done: false },
        { id: 'ck-unfi-3', text: 'Box 120 cases (84 Mild, 36 Hot)', done: false },
        { id: 'ck-unfi-4', text: 'Palletize UNFI pallet (120 cases)', done: false },
        { id: 'ck-unfi-5', text: 'Generate BOL', done: false },
        { id: 'ck-unfi-6', text: 'Store pallet until Mar 25 pickup', done: false },
      ],
    ...
    },
    {
      ...
      items: [
        ...
        { sku: 'TH02', flavor: 'Hot', cases: 50, price: 25, packed: 0 },
      ...
      checklist: [
        { id: 'ck-1', text: 'Swap green caps on 180 Mild bottles (at home, before Friday)', done: false },
        { id: 'ck-2', text: 'U-LINE boxes arrive (tomorrow)', done: false },
        { id: 'ck-3', text: 'Bring from home: 75 Hot + 180 Mild + 40 Sriracha + 75 boxes', done: false },
        { id: 'ck-4', text: 'Bottle from botes: 225 Hot', done: false },
        { id: 'ck-5', text: 'Bottle from botes: 180 Mango', done: false },
        { id: 'ck-6', text: 'Bottle from botes: 60 Truffle', done: false },
        { id: 'ck-7', text: 'Bottle from botes: 80 Sriracha', done: false },
        { id: 'ck-8', text: 'Make U-LINE boxes as needed', done: false },
        { id: 'ck-9', text: 'Box all 140 cases (50 Hot, 30 Mild, 30 Mango, 10 Truffle, 20 Sriracha)', done: false },
        { id: 'ck-10', text: 'Palletize EXP pallet (140 cases)', done: false },
        { id: 'ck-11', text: 'Generate BOL', done: false },
        { id: 'ck-12', text: 'Confirm pickup time with EXP', done: false },
      ],
