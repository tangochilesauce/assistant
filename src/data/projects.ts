...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    color: '#f97316',
    weight: 0,
    goal: 'Single source of truth for all Tango business relationships',
    defaultActions: [],
    parentSlug: 'tango',
  },
  {
    ...
    color: '#f97316',
    weight: 0,
    goal: 'Sales expansion — store targets, pitches, outreach',
    defaultActions: [],
    parentSlug: 'tango',
  },
  {
    ...
    color: '#f97316',
    weight: 0,
    goal: 'B2B wholesale through Faire marketplace',
    defaultActions: [],
    parentSlug: 'tango',
  },
  {
